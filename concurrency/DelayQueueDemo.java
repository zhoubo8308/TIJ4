...
class DelayedTask implements Runnable, Delayed {
	...
	protected static java.util.List<DelayedTask> sequence = new ArrayList<DelayedTask>();

	public DelayedTask(int delayInMilliseconds) {
		delta = delayInMilliseconds;
		trigger = System.nanoTime() + NANOSECONDS.convert(delta, MILLISECONDS);//convert delta from milliseconds to nanoseconds
		sequence.add(this);
	}
	...
	// This inner class should be the last node, print the sequence and shutdown executor
...
//consumer just take the task out of the queue to run.
